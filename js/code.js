class Code{
    ...
    getChar(){
        ...
        divs.style.cssText=`width:50px;height:50px;background:url(${this.char[num][1]}) center no-repeat;color:transparent;border-radius:50%;font-size:20px;position:absolute;top:${tops}px;left:${lefts}px;line-height:50px;text-align:center;font-weight:600;`;
